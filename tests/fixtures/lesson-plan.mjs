export function makeGeneratedPlan(overrides = {}) {
    return {
        ...
        sessions: [{ id: 'session-1', order: 1, title: '식물 기관 관찰', sessionMinutes: 40, nextSessionConnection: '관찰 결과를 식물 기관의 기능과 연결한다.', stages: [
            { phase: '도입', learningElement: '관찰 문제 확인', teacherActivities: ['질문을 제시한다.'], studentActivities: ['예상한다.'], teacherQuestions: ['식물의 기관은 어떤 일을 할까요?'], expectedStudentResponses: ['기관마다 하는 일이 다를 것 같습니다.'], supportNotes: [], minutes: 5, materialsAndNotes: [] },
            { phase: '전개', learningElement: '식물 기관 관찰', teacherActivities: ['관찰을 안내한다.'], studentActivities: ['관찰하고 기록한다.'], teacherQuestions: ['관찰한 구조에서 어떤 특징을 찾았나요?'], expectedStudentResponses: ['뿌리에는 가는 털이 있습니다.'], supportNotes: ['관찰 문장 틀을 제공한다.'], minutes: 30, materialsAndNotes: ['안전하게 다룬다.'] },
            { phase: '정리', learningElement: '관찰 결과 공유', teacherActivities: ['핵심을 정리한다.'], studentActivities: ['결과를 설명한다.'], teacherQuestions: ['관찰 결과로 알게 된 점은 무엇인가요?'], expectedStudentResponses: ['기관의 구조와 기능이 관련되어 있습니다.'], supportNotes: [], minutes: 5, materialsAndNotes: [] },
        ] }],
