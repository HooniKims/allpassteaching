...
export function createEmptyWorkflow() {
    return { activeProcess: 'lesson', lessonSnapshot: null, worksheet: null, assessmentRequest: createDefaultAssessmentRequest(), assessment: null, students: [], submissions: [], records: [], recordTargetBytes: DEFAULT_RECORD_TARGET_BYTES };
}
...
export function sanitizeWorkflow(value = {}) {
    ...
    return {
        ...
        assessmentRequest,
        assessment: value.assessment == null ? null : upgradeAssessmentStudentSheet(hydrateGraspsTask(sanitizeAssessment(value.assessment) ?? null)),
