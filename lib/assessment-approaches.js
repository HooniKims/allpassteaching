export const ASSESSMENT_APPROACHES = Object.freeze([
    ...
    },
    {
        ...
        name: 'GRASPS 실제적 수행과제',
        summary: '목표·역할·청중·상황·산출물·성공 기준을 두고 지식과 기능의 실제 적용을 확인합니다.',
        plainGuide: '학생이 실제와 비슷한 역할과 상황에서 배운 지식과 기능을 적용하는 평가예요.',
        plainGuideParts: ['학생이 실제와 비슷한 역할과', '상황에서 배운 지식과 기능을', '적용하는 평가예요.'],
        flow: ['목표(G)', '역할(R)', '청중(A)', '상황(S)', '산출물(P)', '성공 기준(S)'],
        useWhen: '학생이 배운 내용을 실제 맥락에서 적용·설명·제안해야 할 때',
        promptDirective: 'GRASPS의 목표(Goal)·역할(Role)·청중(Audience)·상황(Situation)·산출물/수행(Product/Performance)·성공 기준(Success criteria)을 분명히 제시하고, 실제 맥락에서의 적용과 근거 제시를 평가하세요.',
    },
    {
        id: 'project-based',
        name: '프로젝트 기반 평가',
    ...
    },
    {
        ...
        summaryParts: ['문제 설정, 가설·전략, 자료 해석,', '해결안 검증의 사고 과정을 봅니다.'],
        ...
        useWhenParts: ['과학 탐구·수학적 문제해결·', '사회 현안 분석처럼', '추론 과정이 중요한 때'],
    ...
    },
    {
        ...
        summaryParts: ['주장과 근거, 경청·응답, 질의응답,', '발표 자료를 관찰 가능한 증거로 평가합니다.'],
    ...
    },
    {
        ...
        summaryParts: ['공개된 기준을 활용해 자기 점검과', '동료 피드백 뒤 수정한 증거를 봅니다.'],
