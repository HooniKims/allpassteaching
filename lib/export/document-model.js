...
export const PROCESS_COLUMNS = Object.freeze([
    { key: 'phase', label: '단계' },
...
export const ASSESSMENT_COLUMNS = Object.freeze([
...
function buildProcessRow(stage) {
    return {
        ...
        teacherActivity: [
            { label: '교사 활동', items: [...stage.teacherActivities] },
            { label: '주요 발문', items: [...stage.teacherQuestions] },
        ],
        studentActivity: [
            { label: '학생 활동', items: [...stage.studentActivities] },
            { label: '예상 학생 반응', items: [...stage.expectedStudentResponses] },
        ],
        minutes: stage.minutes,
        notes: [
            { label: '자료·유의점', items: [...stage.materialsAndNotes] },
            { label: '지원', items: [...stage.supportNotes] },
        ],
    };
}
