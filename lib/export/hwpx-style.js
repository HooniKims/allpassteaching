...
export function buildHwpxHeader(baseHeader) {
    ...
    const charProperties = [
        { id: 7, height: 1000, color: '#000000' },
        { id: 8, height: 1800, color: '#000000', bold: true },
        { id: 9, height: 1200, color: '#000000', bold: true },
        { id: 10, height: 900, color: '#000000', bold: true },
        { id: 11, height: 900, color: '#000000' },
