...
export async function buildWorkflowPdf(kind, value, options = {}) {
    ...
    addPage(context);
    if (isWorksheet) drawWorksheet(context, value, kind !== 'worksheet-student', { addPage, colors: COLORS, contentHeight: TOP - MARGIN, ensure, heading, margin: MARGIN, measureText, text, width: WIDTH });
