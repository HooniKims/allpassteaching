import { subjectAreaFromCode } from './scope.js';

const STANDARD_START = /^\[([0-9]{1,2}[가-힣A-Za-z]+(?:\([가-힣A-Za-z]+\))?\d*-[0-9]{1,2}(?:-[0-9]{1,2})?)\]\s*(.+)$/;
    ...
    for (const raw of markdown.split(/\r?\n/)) {
        ...
        if (standardMatch) {
            ...
            current = {
                ...
                subjectArea: subjectAreaFromCode(standardMatch[1]),
