export const DEFAULT_RECORD_TARGET_BYTES = 700;
export const MIN_RECORD_TARGET_BYTES = 300;
export const MAX_RECORD_TARGET_BYTES = 1500;
export const RECORD_TARGET_BYTE_PRESETS = Object.freeze([500, DEFAULT_RECORD_TARGET_BYTES, 1000, MAX_RECORD_TARGET_BYTES]);
