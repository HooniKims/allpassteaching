...
const submission = object({
    ...
    originalAttached: boolean, originalReviewedAt: nullable(text), originalRevision: number, reviewedOriginalRevision: nullable(number), confirmedElementIds: textArray,
