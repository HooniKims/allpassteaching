...
export const worksheetFormats = Object.freeze([
    ...
    format('blended-learning', '블렌디드 학습 확인·적용지', '사전 학습 증거와 오개념을 확인하고 교실 적용 및 후속 피드백을 연결한다.', '온라인 사전 학습과 교실 활동을 이어서 확인하고 적용해 보게 할 때 좋아요.', ['사전 학습 확인', '교실 적용', '피드백과 후속 학습'], ['blended']),
